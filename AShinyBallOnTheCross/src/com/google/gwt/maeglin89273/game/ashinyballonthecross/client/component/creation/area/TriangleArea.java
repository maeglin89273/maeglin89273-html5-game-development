...
public class TriangleArea extends PhysicalArea{
	 ...
	 * @param angle
	 */
	public TriangleArea(Creator creator, int contentPower,
			boolean beControlled, Point p, Vector[] vertices) {
		super(creator, contentPower, beControlled, p, 0, 0,0);
		if(isVerified()){
	...
	public static class TriangleAreaDefiner extends TriangleKindAreaDefiner{
		...
		public TriangleAreaDefiner(Creator creator) {
				
			super(creator, ASBOTXConfigs.CreationPowerComsumption.TRIANGLE_AREA, new Point(2*ICON_BOUNDS_PLUS_SPACING,0));
		...
		protected MainCreation create(int requiredPower) {
			return new TriangleArea(creator, requiredPower, true, g, relativeVertices);
		}

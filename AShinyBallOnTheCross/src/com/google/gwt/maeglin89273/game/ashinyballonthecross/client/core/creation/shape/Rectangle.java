...
public class Rectangle extends PhysicalShape{
	...
	public Rectangle(Point p){
		this(0,null, p,Random.nextDouble()*Math.PI, 5+Random.nextInt(21), 5+Random.nextInt(21),ASBOTXConfigs.Color.getRandomShapeBorderColor());
	}
	/**
	 * 
	 * @param creator
	 ...
	 * @param color
	 */
	public Rectangle(ShapesController controller, Point p,double angle,double width,double height,CssColor color){
		this( (int)Math.floor(((width+height)/2)),controller, p, angle, width, height, color);

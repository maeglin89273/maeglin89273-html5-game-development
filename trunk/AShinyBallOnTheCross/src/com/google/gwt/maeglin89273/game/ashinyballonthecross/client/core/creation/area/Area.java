...
public abstract class Area extends MainCreation {
	 ...
	 * @param h
	 */
	protected Area(int contentPower,boolean beControlled, Point p, double w, double h, double a) {
		super(contentPower,beControlled, p, w, h, a);
	}
	
	//some implements of definers
	public static abstract class AreaDefiner extends CreationDefiner{
		
		protected AreaDefiner( int requiredFullPower,Point iconCorner){
	...
	public static abstract class CircleKindAreaDefiner extends AreaDefiner{
		...
		protected CircleKindAreaDefiner( int requiredFullPower,Point iconCorner,int maxR, int minR) {
			super(requiredFullPower, iconCorner);
			maxRadi = maxR;
			minRadi = minR;
			radius=minRadi;
	...
	public static abstract class TriangleKindAreaDefiner extends AreaDefiner{
		...
		protected TriangleKindAreaDefiner(int requiredFullPower, Point iconCorner) {
			super( requiredFullPower, iconCorner);
